...
public final class ItemStack {
	...
	public static ItemStack func_35864_a(NBTTagCompound var0) {
	...
	public ItemStack func_35863_b(World var1, EntityPlayer var2) {
		return this.getItem().func_35413_b(this, var1, var2);
	}
	...
	public int func_35866_m() {
		return this.getItem().func_35411_c(this);
	}

	public EnumAction func_35865_n() {
		return this.getItem().func_35412_b(this);
	}

	public void func_35862_a(World var1, EntityPlayer var2, int var3) {
		this.getItem().func_35414_a(this, var1, var2, var3);
	}
}
