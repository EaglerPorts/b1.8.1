...
public class CanvasIsomPreview extends Canvas implements KeyListener, MouseListener, MouseMotionListener, Runnable {
	...
	public void loadWorld(String var1) {
		...
		this.worldObj = new World(new SaveHandler(new File(this.dataFolder, "saves"), var1, false), var1, new WorldSettings((new Random()).nextLong(), 0, true));
	...
	public void drawScreen(Graphics2D var1) {
		...
		int var10000 = var17.y + var17.height + 16;
		this.worldObj.getClass();
		int var9 = (var10000 + 128) / var4 + 1 + var5 * 2;
