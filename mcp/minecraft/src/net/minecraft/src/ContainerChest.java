...
public class ContainerChest extends Container {
	...
	public ItemStack getStackInSlot(int var1) {
		...
		if(var3 != null && var3.getHasStack()) {
			...
			if(var1 < this.numRows * 9) {
				if(!this.func_28125_a(var4, this.numRows * 9, this.inventorySlots.size(), true)) {
					return null;
				}
			} else if(!this.func_28125_a(var4, 0, this.numRows * 9, false)) {
				return null;
			}
	...
	public void onCraftGuiClosed(EntityPlayer var1) {
		...
		this.lowerChestInventory.func_35141_y_();
	}
}
