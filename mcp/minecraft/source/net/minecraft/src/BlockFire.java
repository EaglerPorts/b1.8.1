...
public class BlockFire extends Block {
	...
	public void initializeBlock() {
		...
		this.setBurnRate(Block.field_35278_bv.blockID, 15, 100);
	}
						...
						for(int var10 = var3 - 1; var10 <= var3 + 4; ++var10) {
							if(var8 != var2 || var10 != var3 || var9 != var4) {
								...
								if(var12 > 0) {
									...
									if(var13 > 0 && var5.nextInt(var11) <= var13 && (!var1.isRaining() || !var1.canLightningStrikeAt(var8, var10, var9)) && !var1.canLightningStrikeAt(var8 - 1, var10, var4) && !var1.canLightningStrikeAt(var8 + 1, var10, var9) && !var1.canLightningStrikeAt(var8, var10, var9 - 1) && !var1.canLightningStrikeAt(var8, var10, var9 + 1)) {
