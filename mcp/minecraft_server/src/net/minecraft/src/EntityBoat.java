	...
	public void onUpdate() {
		...
		if(this.worldObj.singleplayerWorld) {
			if(this.field_9176_d > 0) {
				var21 = this.posX + (this.boatX - this.posX) / (double)this.field_9176_d;
				var6 = this.posY + (this.boatY - this.posY) / (double)this.field_9176_d;
				var8 = this.posZ + (this.boatZ - this.posZ) / (double)this.field_9176_d;
				...
				this.rotationPitch = (float)((double)this.rotationPitch + (this.boatPitch - (double)this.rotationPitch) / (double)this.field_9176_d);
				--this.field_9176_d;
