...
public final class SpawnerAnimals {
					...
					while(true) {
						...
						do {
							do {
								...
								var13 = (SpawnListEntry)WeightedRandom.func_35689_a(var0.rand, var12);
								ChunkPosition var14 = getRandomSpawningPointInChunk(var0, var10.chunkXPos * 16, var10.chunkZPos * 16);
								var15 = var14.x;
								var16 = var14.y;
								var17 = var14.z;
							} while(var0.isBlockNormalCube(var15, var16, var17));
	...
	public static void func_35573_a(World var0, BiomeGenBase var1, int var2, int var3, int var4, int var5, Random var6) {
		List var7 = var1.getSpawnableList(EnumCreatureType.creature);
		if(!var7.isEmpty()) {
			while(var6.nextFloat() < var1.getBiome()) {
				SpawnListEntry var8 = (SpawnListEntry)WeightedRandom.func_35689_a(var0.rand, var7);
				int var9 = var8.field_35484_b + var6.nextInt(1 + var8.field_35485_c - var8.field_35484_b);
				...
				for(int var14 = 0; var14 < var9; ++var14) {
					...
					for(int var16 = 0; !var15 && var16 < 4; ++var16) {
						int var17 = var0.findTopSolidBlock(var10, var11);
