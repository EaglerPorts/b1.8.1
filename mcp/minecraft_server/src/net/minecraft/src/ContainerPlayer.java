...
public class ContainerPlayer extends Container {
	...
	public ItemStack getStackInSlot(int var1) {
		...
		if(var3 != null && var3.getHasStack()) {
			...
			var2 = var4.copy();
			if(var1 == 0) {
				if(!this.func_28126_a(var4, 9, 45, true)) {
					return null;
				}
			} else if(var1 >= 9 && var1 < 36) {
				if(!this.func_28126_a(var4, 36, 45, false)) {
					return null;
				}
			} else if(var1 >= 36 && var1 < 45) {
				if(!this.func_28126_a(var4, 9, 36, false)) {
					return null;
				}
			} else if(!this.func_28126_a(var4, 9, 45, false)) {
				return null;
			}
