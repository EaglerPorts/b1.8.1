...
public class GenLayerZoomFuzzy extends GenLayer {
	...
	public int[] func_35018_a(int var1, int var2, int var3, int var4) {
		...
		for(int var12 = 0; var12 < var8 - 1; ++var12) {
			...
			for(int var17 = 0; var17 < var7 - 1; ++var17) {
				...
				var10[var14] = var15;
				var10[var14++ + var11] = this.func_35032_a(var15, var16);
				var10[var14] = this.func_35032_a(var15, var18);
				var10[var14++ + var11] = this.func_35031_b(var15, var18, var16, var19);
				var15 = var18;
				var16 = var19;
			}
		}
	...
	protected int func_35032_a(int var1, int var2) {
		return this.func_35016_a(2) == 0 ? var1 : var2;
	}

	protected int func_35031_b(int var1, int var2, int var3, int var4) {
