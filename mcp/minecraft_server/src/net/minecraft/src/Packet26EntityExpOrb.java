...
public class Packet26EntityExpOrb extends Packet {
	...
	public Packet26EntityExpOrb(EntityXPOrb var1) {
		this.field_35125_a = var1.entityId;
		this.field_35123_b = MathHelper.floor_double(var1.posX * 32.0D);
		this.field_35124_c = MathHelper.floor_double(var1.posY * 32.0D);
		this.field_35121_d = MathHelper.floor_double(var1.posZ * 32.0D);
		this.field_35122_e = var1.func_35153_j_();
	}
