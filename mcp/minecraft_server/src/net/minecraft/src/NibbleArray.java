...
public class NibbleArray {
	...
	public NibbleArray(int var1, int var2) {
		...
		this.field_35661_b = var2;
		this.field_35662_c = var2 + 4;
	}
	...
	public int getNibble(int var1, int var2, int var3) {
		int var4 = var1 << this.field_35662_c | var3 << this.field_35661_b | var2;
		int var5 = var4 >> 1;
		int var6 = var4 & 1;
	...
	public void setNibble(int var1, int var2, int var3, int var4) {
		int var5 = var1 << this.field_35662_c | var3 << this.field_35661_b | var2;
		int var6 = var5 >> 1;
		int var7 = var5 & 1;
		if(var7 == 0) {
