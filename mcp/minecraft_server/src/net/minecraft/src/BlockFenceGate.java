...
public class BlockFenceGate extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World var1, int var2, int var3, int var4) {
		...
		return func_35070_c(var5) ? null : AxisAlignedBB.getBoundingBoxFromPool((double)var2, (double)var3, (double)var4, (double)(var2 + 1), (double)((float)var3 + 1.5F), (double)(var4 + 1));
	}
	...
	public static boolean func_35070_c(int var0) {
		return (var0 & 4) != 0;
	}

	public static int func_35071_d(int var0) {
		return var0 & 3;
	}
}
