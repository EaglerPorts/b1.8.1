...
public class Packet41EntityEffect extends Packet {
	...
	public Packet41EntityEffect(int var1, PotionEffect var2) {
		this.field_35116_a = var1;
		this.field_35114_b = (byte)(var2.func_35649_a() & 255);
		this.field_35115_c = (byte)(var2.func_35652_c() & 255);
		this.field_35113_d = (short)var2.func_35653_b();
	}
