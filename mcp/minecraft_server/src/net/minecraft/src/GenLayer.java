...
public abstract class GenLayer {
	...
	public static GenLayer[] func_35019_a(long var0) {
		...
		var4 = GenLayerZoom.func_35025_a(1000L, var12, var3 + 2);
		...
		GenLayer var19 = GenLayerSmoothZoom.func_35030_a(1000L, (GenLayer)var6, 2);
		GenLayer var22 = GenLayerSmoothZoom.func_35030_a(1000L, (GenLayer)var7, 2);
		GenLayerZoomVoronoi var23 = new GenLayerZoomVoronoi(10L, var20);
		var20.func_35015_b(var0);
	...
	public void func_35015_b(long var1) {
		this.field_35021_b = var1;
		if(this.field_35023_a != null) {
			this.field_35023_a.func_35015_b(var1);
		}
	...
	protected int func_35016_a(int var1) {
		int var2 = (int)((this.field_35022_c >> 24) % (long)var1);
		if(var2 < 0) {
			var2 += var1;
		}
	...
	public abstract int[] func_35018_a(int var1, int var2, int var3, int var4);
}
