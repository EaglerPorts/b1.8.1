...
public class NetServerHandler extends NetHandler implements ICommandListener {
	...
	private MCHash field_10_k = new MCHash();
	...
	public void handlePackets() {
		...
		if((long)this.field_35009_f - this.field_35010_l > 20L) {
			...
			this.field_35013_i = field_35012_k.nextInt();
	...
	public void handleMovementTypePacket(Packet27Position var1) {
		this.playerEntity.setMovementType(var1.getStrafeMovement(), var1.getForwardMovement(), var1.func_22032_g(), var1.isInJump(), var1.getPitchRotation(), var1.getYawRotation());
	}
	...
	public void handleFlying(Packet10Flying var1) {
		...
		if(this.hasMoved) {
			...
			if(this.playerEntity.onGround && !var1.onGround && var15 > 0.0D) {
				this.playerEntity.func_35198_b(0.2F);
			}
			...
			boolean var23 = false;
			if(var19 > 1.0D / 16.0D && !this.playerEntity.isPlayerSleeping() && !this.playerEntity.itemInWorldManager.func_35698_b()) {
				var23 = true;
			...
			boolean var24 = var2.getCollidingBoundingBoxes(this.playerEntity, this.playerEntity.boundingBox.copy().contract((double)var21, (double)var21, (double)var21)).size() == 0;
			...
			if(!this.mcServer.allowFlight && !this.playerEntity.itemInWorldManager.func_35698_b() && !var2.func_27069_b(var25)) {
				if(var15 >= -0.03125D) {
	...
	public void handleBlockDig(Packet14BlockDig var1) {
		...
		if(var1.status == 4) {
			...
			this.playerEntity.func_35196_E();
		} else {
			...
			if(this.playerEntity.itemInWorldManager.func_35698_b()) {
				var4 = false;
			}
			...
			int var9 = MathHelper.func_35475_a(var5 - var19.posX);
			int var20 = MathHelper.func_35475_a(var7 - var19.posZ);
			if(var9 > var20) {
				var20 = var9;
			}
			...
			if(var1.status == 0) {
				if(var20 <= 16 && !var3) {
					...
					this.playerEntity.itemInWorldManager.blockClicked(var5, var6, var7, var1.face);
				}
	...
	public void handlePlace(Packet15Place var1) {
		...
		if(var1.direction == 255) {
			...
			int var10 = MathHelper.func_35475_a(var5 - var9.posX);
			int var11 = MathHelper.func_35475_a(var7 - var9.posZ);
			if(var10 > var11) {
				var11 = var10;
			}
		...
		if(var3 == null || var3.func_35614_l() == 0) {
			...
			this.playerEntity.currentCraftingInventory.updateCraftingResults();
	...
	private void handleSlashCommand(String var1) {
		if(var1.toLowerCase().startsWith("/me ")) {
			...
			this.playerEntity.attackEntityFrom(DamageSource.field_35096_j, 1000);
	...
	public void handleEntityAction(Packet19EntityAction var1) {
		if(var1.state == 1) {
			...
			this.playerEntity.func_35146_g(true);
		} else if(var1.state == 5) {
			this.playerEntity.func_35146_g(false);
	...
	public void handleWindowClick(Packet102WindowClick var1) {
		if(this.playerEntity.currentCraftingInventory.windowId == var1.window_Id && this.playerEntity.currentCraftingInventory.getCanCraft(this.playerEntity)) {
			ItemStack var2 = this.playerEntity.currentCraftingInventory.slotClick(var1.inventorySlot, var1.mouseClick, var1.holdingShift, this.playerEntity);
			if(ItemStack.areItemStacksEqual(var1.itemStack, var2)) {
				...
				this.field_10_k.addKey(this.playerEntity.currentCraftingInventory.windowId, Short.valueOf(var1.action));
	...
	public void func_35004_a(Packet107CreativeSetSlot var1) {
		if(this.playerEntity.itemInWorldManager.func_35698_b()) {
			boolean var2 = var1.field_35108_a >= 36 && var1.field_35108_a < 36 + InventoryPlayer.func_25054_e();
			boolean var3 = var1.field_35106_b >= -1 && var1.field_35106_b < Item.itemsList.length && (var1.field_35106_b < 0 || Item.itemsList[var1.field_35106_b] != null);
			boolean var4 = var1.field_35105_d >= 0 && var1.field_35107_c >= 0 && var1.field_35107_c <= 64;
			if(var2 && var3 && var4) {
				if(var1.field_35106_b <= 0) {
					this.playerEntity.personalCraftingInventory.func_35498_a(var1.field_35108_a, (ItemStack)null);
				} else {
					this.playerEntity.personalCraftingInventory.func_35498_a(var1.field_35108_a, new ItemStack(var1.field_35106_b, var1.field_35107_c, var1.field_35105_d));
				}

				this.playerEntity.personalCraftingInventory.setCanCraft(this.playerEntity, true);
			} else if(!var2 && var3 && var4 && var1.field_35108_a == -1 && var1.field_35106_b > 0) {
				this.playerEntity.dropPlayerItem(new ItemStack(var1.field_35106_b, var1.field_35107_c, var1.field_35105_d));
			}
		}
	...
	public void handleTransaction(Packet106Transaction var1) {
		Short var2 = (Short)this.field_10_k.lookup(this.playerEntity.currentCraftingInventory.windowId);
	...
	public void func_35005_a(Packet0KeepAlive var1) {
		if(var1.field_35126_a == this.field_35013_i) {
			int var2 = (int)(System.nanoTime() / 1000000L - this.field_35011_j);
			this.playerEntity.field_35219_i = (this.playerEntity.field_35219_i * 3 + var2) / 4;
		}
