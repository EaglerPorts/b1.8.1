...
public class GenLayerZoomVoronoi extends GenLayer {
	public GenLayerZoomVoronoi(long var1, GenLayer var3) {
		super(var1);
		super.field_35023_a = var3;
	}
	...
	public int[] func_35018_a(int var1, int var2, int var3, int var4) {
		...
		int[] var11 = this.field_35023_a.func_35018_a(var7, var8, var9, var10);
		int var12 = var9 << var5;
		int var13 = var10 << var5;
		int[] var14 = IntCache.func_35549_a(var12 * var13);
		...
		for(int var15 = 0; var15 < var10 - 1; ++var15) {
			...
			for(int var18 = 0; var18 < var9 - 1; ++var18) {
				...
				this.func_35017_a((long)(var18 + var7 << var5), (long)(var15 + var8 << var5));
				double var21 = ((double)this.func_35016_a(1024) / 1024.0D - 0.5D) * var19;
				double var23 = ((double)this.func_35016_a(1024) / 1024.0D - 0.5D) * var19;
				this.func_35017_a((long)(var18 + var7 + 1 << var5), (long)(var15 + var8 << var5));
				double var25 = ((double)this.func_35016_a(1024) / 1024.0D - 0.5D) * var19 + (double)var6;
				double var27 = ((double)this.func_35016_a(1024) / 1024.0D - 0.5D) * var19;
				this.func_35017_a((long)(var18 + var7 << var5), (long)(var15 + var8 + 1 << var5));
				double var29 = ((double)this.func_35016_a(1024) / 1024.0D - 0.5D) * var19;
				double var31 = ((double)this.func_35016_a(1024) / 1024.0D - 0.5D) * var19 + (double)var6;
				this.func_35017_a((long)(var18 + var7 + 1 << var5), (long)(var15 + var8 + 1 << var5));
				double var33 = ((double)this.func_35016_a(1024) / 1024.0D - 0.5D) * var19 + (double)var6;
				double var35 = ((double)this.func_35016_a(1024) / 1024.0D - 0.5D) * var19 + (double)var6;
		...
		int[] var50 = IntCache.func_35549_a(var3 * var4);
