...
public class MapData extends MapDataBase {
	...
	public void func_28155_a(EntityPlayer var1, ItemStack var2) {
		...
		for(int var14 = 0; var14 < this.field_28158_h.size(); ++var14) {
			...
			if(!var4.entityplayerObj.isDead && var4.entityplayerObj.inventory.func_28010_c(var2)) {
				float var5 = (float)(var4.entityplayerObj.posX - (double)this.field_28164_b) / (float)(1 << this.field_28161_e);
				float var6 = (float)(var4.entityplayerObj.posZ - (double)this.field_28163_c) / (float)(1 << this.field_28161_e);
				byte var7 = 64;
				byte var8 = 64;
				if(var5 >= (float)(-var7) && var6 >= (float)(-var8) && var5 <= (float)var7 && var6 <= (float)var8) {
					...
					if(var4.entityplayerObj.dimension == this.field_28162_d) {
