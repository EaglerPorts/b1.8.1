...
public final class ItemStack {
	...
	public static ItemStack func_35618_a(NBTTagCompound var0) {
	...
	public ItemStack func_35617_b(World var1, EntityPlayer var2) {
		return this.getItem().func_35405_b(this, var1, var2);
	}
	...
	public String func_35616_k() {
		return Item.itemsList[this.itemID].func_35407_a(this);
	}
	...
	public int func_35614_l() {
		return this.getItem().func_35404_c(this);
	}

	public EnumAction func_35615_m() {
		return this.getItem().func_35406_b(this);
	}

	public void func_35613_a(World var1, EntityPlayer var2, int var3) {
		this.getItem().func_35408_a(this, var1, var2, var3);
	}
}
