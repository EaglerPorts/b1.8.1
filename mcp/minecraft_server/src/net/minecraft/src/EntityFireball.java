...
public class EntityFireball extends Entity {
	...
	public void onUpdate() {
		...
		if(var3 != null) {
			if(!this.worldObj.singleplayerWorld) {
				if(var3.entityHit != null && var3.entityHit.attackEntityFrom(DamageSource.func_35082_a(this, this.shootingEntity), 0)) {
				}
	...
	public boolean attackEntityFrom(DamageSource var1, int var2) {
		...
		if(var1.func_35080_a() != null) {
			Vec3D var3 = var1.func_35080_a().getLookVec();
			if(var3 != null) {
