...
public class MapInfo {
	...
	public byte[] func_28118_a(ItemStack var1) {
		...
		if(--this.field_28122_f < 0) {
			...
			byte[] var2 = new byte[this.mapDataObj.field_28157_i.size() * 3 + 1];
			var2[0] = 1;

			for(var3 = 0; var3 < this.mapDataObj.field_28157_i.size(); ++var3) {
				MapCoord var4 = (MapCoord)this.mapDataObj.field_28157_i.get(var3);
		...
		for(int var8 = 0; var8 < 10; ++var8) {
			...
			if(this.field_28119_b[var3] >= 0) {
				...
				for(int var7 = 0; var7 < var6.length - 3; ++var7) {
					var6[var7 + 3] = this.mapDataObj.field_28160_f[(var7 + var5) * 128 + var3];
				}
