...
public class Chunk {
	...
	public Chunk(World var1, int var2, int var3) {
		this.field_35637_c = new int[256];
		this.field_35636_d = new boolean[256];
		...
		Arrays.fill(this.field_35637_c, -999);
	}
	...
	private void propagateSkylightOcclusion(int var1, int var2) {
		this.field_35636_d[var1 + var2 * 16] = true;
	}
		...
		if(var10000.doChunksNearChunkExist(var10001, 128 / 2, this.zPosition * 16 + 8, 16)) {
			for(int var1 = 0; var1 < 16; ++var1) {
				for(int var2 = 0; var2 < 16; ++var2) {
					if(this.field_35636_d[var1 + var2 * 16]) {
						this.field_35636_d[var1 + var2 * 16] = false;
	...
	private void checkSkylightNeighborHeight(int var1, int var2, int var3) {
		...
		if(var4 > var3) {
			this.func_35634_d(var1, var2, var3, var4 + 1);
		} else if(var4 < var3) {
			this.func_35634_d(var1, var2, var4, var3 + 1);
		}

	}

	private void func_35634_d(int var1, int var2, int var3, int var4) {
		if(var4 > var3) {
			World var10000 = this.worldObj;
			this.worldObj.getClass();
			if(var10000.doChunksNearChunkExist(var1, 128 / 2, var2, 16)) {
				for(int var5 = var3; var5 < var4; ++var5) {
					this.worldObj.func_35243_b(EnumSkyBlock.Sky, var1, var5, var2);
				}
	...
	private void relightBlock(int var1, int var2, int var3) {
		...
		if(var5 != var4) {
			...
			this.func_35634_d(var7 - 1, var8, var12, var13);
			this.func_35634_d(var7 + 1, var8, var12, var13);
			this.func_35634_d(var7, var8 - 1, var12, var13);
			this.func_35634_d(var7, var8 + 1, var12, var13);
			this.func_35634_d(var7, var8, var12, var13);
			this.isModified = true;
		}
	}
	...
	public boolean setBlockIDWithMetadata(int var1, int var2, int var3, int var4, int var5) {
		...
		if(var2 >= this.field_35637_c[var7] - 1) {
	...
	public boolean setBlockID(int var1, int var2, int var3, int var4) {
		...
		if(var2 >= this.field_35637_c[var6] - 1) {
	...
	public void onChunkUnload() {
		...
		while(var1.hasNext()) {
			...
			this.worldObj.func_35239_a(var2);
		}
	...
	public void func_35632_a(IChunkProvider var1, IChunkProvider var2, int var3, int var4) {
	...
	public int func_35631_c(int var1, int var2) {
