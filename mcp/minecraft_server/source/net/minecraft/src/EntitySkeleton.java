...
public class EntitySkeleton extends EntityMob {
	...
	public void onDeath(DamageSource var1) {
		super.onDeath(var1);
		if(var1.func_35079_e() instanceof EntityArrow && var1.func_35080_a() instanceof EntityPlayer) {
			EntityPlayer var2 = (EntityPlayer)var1.func_35080_a();
			double var3 = var2.posX - this.posX;
			double var5 = var2.posZ - this.posZ;
			if(var3 * var3 + var5 * var5 >= 2500.0D) {
				var2.triggerAchievement(AchievementList.field_35490_v);
			}
		}
