...
public class EntityArrow extends Entity {
	...
	public boolean field_35160_d = false;
		...
		if(this.inGround) {
			...
			if(var3 != null) {
				if(var3.entityHit != null) {
					...
					if(this.field_35160_d) {
						var20 = var20 * 3 / 2 + 1;
					}

					if(var3.entityHit.attackEntityFrom(DamageSource.func_35073_a(this, this.shootingEntity), var20)) {
						if(var3.entityHit instanceof EntityLiving) {
							++((EntityLiving)var3.entityHit).field_35189_aD;
						}
