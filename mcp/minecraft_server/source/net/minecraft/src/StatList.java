...
public class StatList {
	...
	public static void initBreakableStats() {
		...
		objectBreakStats = func_25087_b(objectBreakStats, "stat.breakItem", 16973824, 0, Block.blocksList.length);
	...
	public static void func_25086_b() {
		...
		objectBreakStats = func_25087_b(objectBreakStats, "stat.breakItem", 16973824, Block.blocksList.length, 32000);
