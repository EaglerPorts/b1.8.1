...
public class FurnaceRecipes {
	...
	private FurnaceRecipes() {
		...
		this.addSmelting(Item.field_35413_bg.shiftedIndex, new ItemStack(Item.field_35414_bh));
		this.addSmelting(Item.field_35415_bi.shiftedIndex, new ItemStack(Item.field_35409_bj));
