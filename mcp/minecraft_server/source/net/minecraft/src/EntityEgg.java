	...
	public void onUpdate() {
		...
		if(!this.worldObj.singleplayerWorld) {
			...
			for(int var8 = 0; var8 < var5.size(); ++var8) {
				...
				if(var9.canBeCollidedWith() && (var9 != this.owner || this.field_20079_al >= 5)) {
					float var10 = 0.3F;
		...
		if(var3 != null) {
			if(var3.entityHit != null && var3.entityHit.attackEntityFrom(DamageSource.func_35081_a(this, this.owner), 0)) {
			}
