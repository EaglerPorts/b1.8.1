...
public class ChunkProviderSky implements IChunkProvider {
	...
	public ChunkProviderSky(World var1, long var2) {
		...
		this.field_28084_k = new NoiseGeneratorOctaves(this.random, 16);
		this.field_28083_l = new NoiseGeneratorOctaves(this.random, 16);
		this.field_28082_m = new NoiseGeneratorOctaves(this.random, 8);
		this.field_28081_n = new NoiseGeneratorOctaves(this.random, 4);
		this.field_28080_o = new NoiseGeneratorOctaves(this.random, 4);
		this.field_28094_a = new NoiseGeneratorOctaves(this.random, 10);
		this.field_28093_b = new NoiseGeneratorOctaves(this.random, 16);
		this.field_28092_c = new NoiseGeneratorOctaves(this.random, 8);
	}
	...
	public void generateTerrain(int var1, int var2, byte[] var3, BiomeGenBase[] var4) {
		...
		int var7 = 128 / 4 + 1;
		int var8 = var5 + 1;
		this.field_28078_q = this.func_28071_a(this.field_28078_q, var1 * var5, 0, var2 * var5, var6, var7, var8);
		...
		for(int var9 = 0; var9 < var5; ++var9) {
			for(int var10 = 0; var10 < var5; ++var10) {
				...
				while(true) {
					...
					double var12 = 0.25D;
					double var14 = this.field_28078_q[((var9 + 0) * var8 + var10 + 0) * var7 + var11 + 0];
					double var16 = this.field_28078_q[((var9 + 0) * var8 + var10 + 1) * var7 + var11 + 0];
					double var18 = this.field_28078_q[((var9 + 1) * var8 + var10 + 0) * var7 + var11 + 0];
					double var20 = this.field_28078_q[((var9 + 1) * var8 + var10 + 1) * var7 + var11 + 0];
					double var22 = (this.field_28078_q[((var9 + 0) * var8 + var10 + 0) * var7 + var11 + 1] - var14) * var12;
					double var24 = (this.field_28078_q[((var9 + 0) * var8 + var10 + 1) * var7 + var11 + 1] - var16) * var12;
					double var26 = (this.field_28078_q[((var9 + 1) * var8 + var10 + 0) * var7 + var11 + 1] - var18) * var12;
					double var28 = (this.field_28078_q[((var9 + 1) * var8 + var10 + 1) * var7 + var11 + 1] - var20) * var12;
	...
	public void replaceBlocksForBiome(int var1, int var2, byte[] var3, BiomeGenBase[] var4) {
		...
		this.unusedSandNoise = this.field_28081_n.generateNoiseOctaves(this.unusedSandNoise, var1 * 16, var2 * 16, 0, 16, 16, 1, var5, var5, 1.0D);
		this.unusedGravelNoise = this.field_28081_n.generateNoiseOctaves(this.unusedGravelNoise, var1 * 16, 109, var2 * 16, 16, 1, 16, var5, 1.0D, var5);
		this.stoneNoise = this.field_28080_o.generateNoiseOctaves(this.stoneNoise, var1 * 16, var2 * 16, 0, 16, 16, 1, var5 * 2.0D, var5 * 2.0D, var5 * 2.0D);
	...
	private double[] func_28071_a(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		for(int var14 = 0; var14 < var5; ++var14) {
			for(int var15 = 0; var15 < var7; ++var15) {
				double var16 = (this.field_28088_g[var13] + 256.0D) / 512.0D;
				if(var16 > 1.0D) {
					var16 = 1.0D;
				}

				double var18 = this.field_28087_h[var13] / 8000.0D;
				if(var18 < 0.0D) {
					var18 = -var18 * 0.3D;
				}
				...
				for(int var22 = 0; var22 < var6; ++var22) {
					...
					double var27 = this.field_28090_e[var12] / 512.0D;
					double var29 = this.field_28089_f[var12] / 512.0D;
					double var31 = (this.field_28091_d[var12] / 10.0D + 1.0D) / 2.0D;
					if(var31 < 0.0D) {
						var23 = var27;
					} else if(var31 > 1.0D) {
						var23 = var29;
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		var11 = 0.5D;
		var13 = (int)((this.field_28092_c.func_647_a((double)var4 * var11, (double)var5 * var11) / 8.0D + this.random.nextDouble() * 4.0D + 4.0D) / 3.0D);
		var14 = 0;
		...
		if(var6 == BiomeGenBase.field_35520_c) {
			var14 -= 20;
		}
