...
public class ItemDoor extends Item {
	...
	public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7) {
		if(var7 != 1) {
			...
			if(var2.func_35200_c(var4, var5, var6) && var2.func_35200_c(var4, var5 + 1, var6)) {
				if(!var8.canPlaceBlockAt(var3, var4, var5, var6)) {
					...
					func_35418_a(var3, var4, var5, var6, var9, var8);
					--var1.stackSize;
					return true;
				}
			} else {
	...
	public static void func_35418_a(World var0, int var1, int var2, int var3, int var4, Block var5) {
		byte var6 = 0;
		byte var7 = 0;
		if(var4 == 0) {
			var7 = 1;
