...
public abstract class Entity {
	...
	public void onEntityUpdate() {
		...
		if(this.worldObj.singleplayerWorld) {
			...
			if(this.isImmuneToFire) {
				...
				if(this.fire % 20 == 0) {
					this.attackEntityFrom(DamageSource.field_35089_b, 1);
				}
	...
	protected void setOnFireFromLava() {
		if(!this.isImmuneToFire) {
			this.attackEntityFrom(DamageSource.field_35090_c, 4);
			this.fire = 600;
		}
			...
			if(this.canTriggerWalking() && !var18 && this.ridingEntity == null) {
				...
				if(this.distanceWalkedModified > (float)this.nextStepDistance && var28 > 0) {
					...
					if(this.worldObj.getBlockId(var38, var26 + 1, var39) == Block.snow.blockID) {
						...
						this.worldObj.playSoundAtEntity(this, var29.stepSoundDir(), var29.getVolume() * 0.15F, var29.getPitch());
	...
	public void func_35146_g(boolean var1) {
		this.setFlag(3, var1);
	}

	public void func_35148_h(boolean var1) {
		this.setFlag(4, var1);
	}
