...
public class EntitySlime extends EntityLiving implements IMob {
	...
	public void onCollideWithPlayer(EntityPlayer var1) {
		int var2 = this.getSlimeSize();
		if(var2 > 1 && this.canEntityBeSeen(var1) && (double)this.getDistanceToEntity(var1) < 0.6D * (double)var2 && var1.attackEntityFrom(DamageSource.func_35072_a(this), var2)) {
	...
	public boolean getCanSpawnHere() {
		...
		return (this.getSlimeSize() == 1 || this.worldObj.difficultySetting > 0) && this.rand.nextInt(10) == 0 && var1.func_334_a(987234911L).nextInt(10) == 0 && this.posY < 16.0D;
	}
