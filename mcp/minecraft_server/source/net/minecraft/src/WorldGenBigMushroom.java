...
public class WorldGenBigMushroom extends WorldGenerator {
	private int field_35293_a = -1;

	public WorldGenBigMushroom(int var1) {
		this.field_35293_a = var1;
	}
	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		if(this.field_35293_a >= 0) {
			var6 = this.field_35293_a;
		}
			...
			if(var10000 <= 128) {
					...
					for(var12 = var3 - var11; var12 <= var3 + var11; ++var12) {
						for(var13 = var5 - var11; var13 <= var5 + var11; ++var13) {
							...
							if((var14 != 0 || var4 >= var4 + var7 - 1) && !Block.opaqueCubeLookup[var1.getBlockId(var12, var15, var13)]) {
								var1.setBlockAndMetadata(var12, var15, var13, Block.field_35053_bo.blockID + var6, var14);
							}
						}
					}
				}
				...
				for(var15 = 0; var15 < var7; ++var15) {
					...
					if(!Block.opaqueCubeLookup[var11]) {
						var1.setBlockAndMetadata(var3, var4 + var15, var5, Block.field_35053_bo.blockID + var6, 10);
					}
				}
