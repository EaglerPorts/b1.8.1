...
public class Item {
	...
	public static Item appleGold = (new ItemFood(66, 10, 1.2F, false)).func_35423_n().func_35422_a(Potion.field_35458_l.field_35447_H, 30, 0, 1.0F).setIconCoord(11, 0).setItemName("appleGold");
	...
	public static Item field_35416_bd = (new ItemFood(104, 2, 0.3F, false)).setIconCoord(13, 6).setItemName("melon");
	public static Item field_35417_be = (new ItemSeeds(105, Block.field_35051_bt.blockID)).setIconCoord(13, 3).setItemName("seeds_pumpkin");
	public static Item field_35412_bf = (new ItemSeeds(106, Block.field_35050_bu.blockID)).setIconCoord(14, 3).setItemName("seeds_melon");
	public static Item field_35413_bg = (new ItemFood(107, 3, 0.3F, true)).setIconCoord(9, 6).setItemName("beefRaw");
	public static Item field_35414_bh = (new ItemFood(108, 8, 0.8F, true)).setIconCoord(10, 6).setItemName("beefCooked");
	public static Item field_35415_bi = (new ItemFood(109, 2, 0.3F, true)).func_35422_a(Potion.field_35468_s.field_35447_H, 30, 0, 0.3F).setIconCoord(9, 7).setItemName("chickenRaw");
	...
	public void func_35408_a(ItemStack var1, World var2, EntityPlayer var3, int var4) {
	}
