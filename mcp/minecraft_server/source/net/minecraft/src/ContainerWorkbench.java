...
public class ContainerWorkbench extends Container {
	...
	public ItemStack getStackInSlot(int var1) {
		...
		if(var3 != null && var3.getHasStack()) {
			...
			var2 = var4.copy();
			if(var1 == 0) {
				if(!this.func_28126_a(var4, 10, 46, true)) {
					return null;
				}
			} else if(var1 >= 10 && var1 < 37) {
				if(!this.func_28126_a(var4, 37, 46, false)) {
					return null;
				}
			} else if(var1 >= 37 && var1 < 46) {
				if(!this.func_28126_a(var4, 10, 37, false)) {
					return null;
				}
			} else if(!this.func_28126_a(var4, 10, 46, false)) {
				return null;
			}
