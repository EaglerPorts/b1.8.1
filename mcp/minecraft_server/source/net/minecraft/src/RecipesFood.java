...
public class RecipesFood {
	public void addRecipes(CraftingManager var1) {
		...
		var1.addRecipe(new ItemStack(Block.field_35048_bs), new Object[]{"MMM", "MMM", "MMM", Character.valueOf('M'), Item.field_35416_bd});
		var1.addRecipe(new ItemStack(Item.field_35412_bf), new Object[]{"M", Character.valueOf('M'), Item.field_35416_bd});
	}
}
