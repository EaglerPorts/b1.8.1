...
public abstract class Container {
				...
				if(var1 == -999) {
					...
					if(var7 != null) {
						...
						if(var9 != null && var9.getStack() != null && var9.getStack().itemID == var8) {
							this.func_35497_b(var1, var2, var3, var4);
						}
					}
				} else {
					if(var1 < 0) {
	...
	protected void func_35497_b(int var1, int var2, boolean var3, EntityPlayer var4) {
	...
	public void func_35498_a(int var1, ItemStack var2) {
	...
	protected boolean func_28126_a(ItemStack var1, int var2, int var3, boolean var4) {
		boolean var5 = false;
		int var6 = var2;
		if(var4) {
			var6 = var3 - 1;
		...
		if(var1.isStackable()) {
			while(var1.stackSize > 0 && (!var4 && var6 < var3 || var4 && var6 >= var2)) {
				...
				var8 = var7.getStack();
				if(var8 != null && var8.itemID == var1.itemID && (!var1.getHasSubtypes() || var1.getItemDamage() == var8.getItemDamage())) {
