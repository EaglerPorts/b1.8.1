...
public class EntityTrackerEntry {
	...
	public void updatePlayerList(List var1) {
		...
		++this.field_28165_t;
		if(++this.updateCounter % this.field_9234_e == 0 || this.trackedEntity.field_35151_ca) {
		...
		this.trackedEntity.field_35151_ca = false;
	...
	private Packet getSpawnPacket() {
		if(this.trackedEntity instanceof EntityItem) {
			...
			if(this.trackedEntity instanceof EntityBoat) {
				...
				Packet23VehicleSpawn var2 = new Packet23VehicleSpawn(this.trackedEntity, 63, ((EntityFireball)this.trackedEntity).shootingEntity.entityId);
				var2.field_28044_e = (int)(var4.accelerationX * 8000.0D);
				var2.field_28043_f = (int)(var4.accelerationY * 8000.0D);
				var2.field_28042_g = (int)(var4.accelerationZ * 8000.0D);
				return var2;
