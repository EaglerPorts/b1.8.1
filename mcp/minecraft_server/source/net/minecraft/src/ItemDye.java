	...
	public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7) {
		if(!var2.func_35200_c(var4, var5, var6)) {
			...
			if(var8 == Block.sapling.blockID) {
				...
				if(var8 != Block.field_35050_bu.blockID && var8 != Block.field_35051_bt.blockID) {
					...
					if(!var3.singleplayerWorld) {
						((BlockStem)Block.blocksList[var8]).func_35066_f_(var3, var4, var5, var6);
						--var1.stackSize;
					}
				...
				if(!var3.singleplayerWorld && ((BlockMushroom)Block.blocksList[var8]).func_35065_b(var3, var4, var5, var6, var3.rand)) {
					--var1.stackSize;
				}
