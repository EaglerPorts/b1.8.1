...
public class ComponentVillageField extends ComponentVillage {
	...
	public static ComponentVillageField func_35370_a(List var0, Random var1, int var2, int var3, int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.func_35663_a(var2, var3, var4, 0, 0, 0, 13, 4, 9, var5);
		return func_35366_a(var7) && StructureComponent.func_35312_a(var0, var7) == null ? new ComponentVillageField(var6, var1, var7, var5) : null;
	}

	public boolean func_35310_a(World var1, Random var2, StructureBoundingBox var3) {
		if(this.field_35371_a < 0) {
			this.field_35371_a = this.func_35367_b(var1, var3);
			if(this.field_35371_a < 0) {
				return true;
			}
		...
		this.func_35294_a(var1, var3, 0, 1, 0, 12, 4, 8, 0, 0, false);
		...
		this.func_35294_a(var1, var3, 7, 0, 1, 8, 0, 7, Block.tilledField.blockID, Block.tilledField.blockID, false);
		this.func_35294_a(var1, var3, 10, 0, 1, 11, 0, 7, Block.tilledField.blockID, Block.tilledField.blockID, false);
		...
		this.func_35294_a(var1, var3, 12, 0, 0, 12, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
		this.func_35294_a(var1, var3, 1, 0, 0, 11, 0, 0, Block.wood.blockID, Block.wood.blockID, false);
		this.func_35294_a(var1, var3, 1, 0, 8, 11, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
		this.func_35294_a(var1, var3, 3, 0, 1, 3, 0, 7, Block.waterMoving.blockID, Block.waterMoving.blockID, false);
		this.func_35294_a(var1, var3, 9, 0, 1, 9, 0, 7, Block.waterMoving.blockID, Block.waterMoving.blockID, false);
		...
		for(var4 = 1; var4 <= 7; ++var4) {
			...
			this.func_35309_a(var1, Block.crops.blockID, MathHelper.func_35476_a(var2, 2, 7), 7, 1, var4, var3);
			this.func_35309_a(var1, Block.crops.blockID, MathHelper.func_35476_a(var2, 2, 7), 8, 1, var4, var3);
			this.func_35309_a(var1, Block.crops.blockID, MathHelper.func_35476_a(var2, 2, 7), 10, 1, var4, var3);
			this.func_35309_a(var1, Block.crops.blockID, MathHelper.func_35476_a(var2, 2, 7), 11, 1, var4, var3);
		}
