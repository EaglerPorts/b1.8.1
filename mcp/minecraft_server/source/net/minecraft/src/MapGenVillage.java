...
public class MapGenVillage extends MapGenStructure {
	...
	protected boolean func_35531_a(int var1, int var2) {
		...
		int var7 = var1 / var3;
		int var8 = var2 / var3;
		Random var9 = this.field_35530_d.func_35238_t(var7, var8, 10387312);
		var7 *= var3;
		var8 *= var3;
		var7 += var9.nextInt(var3 - var4);
		var8 += var9.nextInt(var3 - var4);
		if(var5 == var7 && var6 == var8) {
			boolean var10 = this.field_35530_d.getWorldChunkManager().func_35141_a(var5 * 16 + 8, var6 * 16 + 8, 0, field_35538_a);
			if(var10) {
				return true;
			}
		}
	...
	protected StructureStart func_35533_b(int var1, int var2) {
		return new StructureVillageStart(this.field_35530_d, this.rand, var1, var2);
	}
}
