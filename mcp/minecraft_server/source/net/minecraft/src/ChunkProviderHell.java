...
public class ChunkProviderHell implements IChunkProvider {
	...
	public void func_4061_b(int var1, int var2, byte[] var3) {
		...
		this.gravelNoise = this.field_4237_l.generateNoiseOctaves(this.gravelNoise, var1 * 16, 109, var2 * 16, 16, 1, 16, var5, 1.0D, var5);
		this.field_4231_r = this.field_4236_m.generateNoiseOctaves(this.field_4231_r, var1 * 16, var2 * 16, 0, 16, 16, 1, var5 * 2.0D, var5 * 2.0D, var5 * 2.0D);
