...
public class FurnaceRecipes {
	...
	private FurnaceRecipes() {
		...
		this.addSmelting(Item.field_35417_bj.shiftedIndex, new ItemStack(Item.field_35418_bk));
		this.addSmelting(Item.field_35419_bl.shiftedIndex, new ItemStack(Item.field_35420_bm));
