		...
		if(!this.worldObj.multiplayerWorld) {
					...
					for(var5 = 0; !var4 && var5 <= 5 && var5 >= -5; var5 = var5 <= 0 ? 1 - var5 : 0 - var5) {
						for(int var6 = 0; !var4 && var6 <= 10 && var6 >= -10; var6 = var6 <= 0 ? 1 - var6 : 0 - var6) {
							for(int var7 = 0; !var4 && var7 <= 10 && var7 >= -10; var7 = var7 <= 0 ? 1 - var7 : 0 - var7) {
								...
								if(var8 == Block.field_35289_bm.blockID) {
									this.worldObj.playAuxSFX(2001, var1 + var6, var2 + var5, var3 + var7, Block.field_35289_bm.blockID + this.worldObj.getBlockMetadata(var1 + var6, var2 + var5, var3 + var7) * 256);
									this.worldObj.setBlockWithNotify(var1 + var6, var2 + var5, var3 + var7, 0);
									Block.field_35289_bm.onBlockDestroyedByPlayer(this.worldObj, var1 + var6, var2 + var5, var3 + var7, 0);
			...
			if(this.entityToAttack == null && !this.hasPath()) {
				...
				if(BlockSilverfish.func_35305_d(var5)) {
					this.worldObj.setBlockAndMetadataWithNotify(var1 + PistonBlockTextures.offsetsXForSide[var9], var2 + PistonBlockTextures.offsetsYForSide[var9], var3 + PistonBlockTextures.offsetsZForSide[var9], Block.field_35289_bm.blockID, BlockSilverfish.func_35304_f(var5));
