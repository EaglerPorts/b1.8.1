...
public class TexturePackCustom extends TexturePackBase {
	...
	private VFile2 texturePackFile;

	public TexturePackCustom(VFile2 var1) {
	...
	public void func_6485_a(Minecraft var1) throws IOException {
		...
		try {
			var2 = new ZipFile(ScuffedUtils.getFileFromVFile(this.texturePackFile));
	...
	public void func_6482_a() {
		try {
			this.texturePackZipFile = new ZipFile(ScuffedUtils.getFileFromVFile(this.texturePackFile));
	...
	public InputStream getResourceAsStream(String var1) {
		try {
			ZipEntry var2 = this.texturePackZipFile.getEntry(var1.startsWith("/") ? var1.substring(1) : var1);
			if(var2 != null) {
