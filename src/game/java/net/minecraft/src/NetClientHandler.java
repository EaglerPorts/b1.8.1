...
public class NetClientHandler extends NetHandler {
	...
	public NetClientHandler(Minecraft var1, GuiScreen var2) {
		this.mc = var1;
		this.parent = var2;
	...
	public void handleLogin(Packet1Login var1) {
		...
		this.worldClient = new WorldClient(this, new WorldSettings(var1.mapSeed, var1.field_35249_d, false),
				var1.field_35250_e, var1.field_35247_f);
	...
	public void handlePickupSpawn(Packet21PickupSpawn var1) {
		...
		EntityItem var8 = new EntityItem(this.worldClient, var2, var4, var6,
				new ItemStack(var1.itemID, var1.count, var1.itemDamage));
	...
	public void handleVehicleSpawn(Packet23VehicleSpawn var1) {
		...
		if (var1.type == 63) {
			var8 = new EntityFireball(this.worldClient, var2, var4, var6, (double) var1.field_28047_e / 8000.0D,
					(double) var1.field_28046_f / 8000.0D, (double) var1.field_28045_g / 8000.0D);
		...
		if (var8 != null) {
			...
			if (var1.field_28044_i > 0) {
				...
				((Entity) var8).setVelocity((double) var1.field_28047_e / 8000.0D, (double) var1.field_28046_f / 8000.0D,
	...
	public void func_35778_a(Packet26EntityExpOrb var1) {
		EntityXPOrb var2 = new EntityXPOrb(this.worldClient, (double) var1.field_35239_b, (double) var1.field_35240_c,
				(double) var1.field_35237_d, var1.field_35238_e);
	...
	public void handleMapChunk(Packet51MapChunk var1) {
		this.worldClient.invalidateBlockReceiveRegion(var1.xPosition, var1.yPosition, var1.zPosition,
				var1.xPosition + var1.xSize - 1, var1.yPosition + var1.ySize - 1, var1.zPosition + var1.zSize - 1);
		this.worldClient.setChunkData(var1.xPosition, var1.yPosition, var1.zPosition, var1.xSize, var1.ySize, var1.zSize,
				var1.chunk);
	}

	public void handleBlockChange(Packet53BlockChange var1) {
		this.worldClient.setBlockAndMetadataAndInvalidate(var1.xPosition, var1.yPosition, var1.zPosition, var1.type,
				var1.metadata);
	}
	...
	public void handleKickDisconnect(Packet255KickDisconnect var1) {
		...
		this.mc.displayGuiScreen(new GuiConnectFailed(this.parent, "disconnect.disconnected", "disconnect.genericReason",
				new Object[] { var1.reason }));
	}
	...
	public void handleErrorMessage(String var1, Object[] var2) {
		if (!this.disconnected) {
			this.disconnected = true;
			this.mc.changeWorld1((World) null);
			this.mc.displayGuiScreen(new GuiConnectFailed(this.parent, "disconnect.lost", var1, var2));
		}
	}
	...
	public void handleCollect(Packet22Collect var1) {
		...
		if (var2 != null) {
			this.worldClient.playSoundAtEntity(var2, "random.pop", 0.2F,
	...
	public void disconnect() {
		this.disconnected = true;
		this.netManager.networkShutdown("disconnect.endOfStream", new Object[0]);
	}
	...
	public void handleRespawn(Packet9Respawn var1) {
		if (var1.field_35244_b != this.mc.thePlayer.dimension
				|| var1.field_35246_a != this.mc.thePlayer.worldObj.getRandomSeed()) {
			this.field_1210_g = false;
			this.worldClient = new WorldClient(this, new WorldSettings(var1.field_35246_a, var1.field_35243_e, false),
					var1.field_35244_b, var1.field_35245_c);
			this.worldClient.multiplayerWorld = true;
			this.mc.changeWorld1(this.worldClient);
	...
	public void handleExplosion(Packet60Explosion var1) {
		Explosion var2 = new Explosion(this.mc.theWorld, (Entity) null, var1.explosionX, var1.explosionY, var1.explosionZ,
				var1.explosionSize);
	...
	public void handleOpenWindow(Packet100OpenWindow var1) {
		if (var1.inventoryType == 0) {
			...
			this.mc.thePlayer.displayWorkbenchGUI(MathHelper.floor_double(var5.posX), MathHelper.floor_double(var5.posY),
					MathHelper.floor_double(var5.posZ));
			this.mc.thePlayer.craftingInventory.windowId = var1.windowId;
		}
