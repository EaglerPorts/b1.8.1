...
public class Item {
	...
	public static Item appleGold = (new ItemFood(66, 10, 1.2F, false)).func_35424_o().func_35425_a(Potion.field_35681_l.field_35670_H, 30, 0, 1.0F).setIconCoord(11, 0).setItemName("appleGold");
	...
	public static Item field_35422_bh = (new ItemSeeds(105, Block.field_35284_bt.blockID)).setIconCoord(13, 3).setItemName("seeds_pumpkin");
	public static Item field_35423_bi = (new ItemSeeds(106, Block.field_35283_bu.blockID)).setIconCoord(14, 3).setItemName("seeds_melon");
	...
	public static Item field_35419_bl = (new ItemFood(109, 2, 0.3F, true)).func_35425_a(Potion.field_35691_s.field_35670_H, 30, 0, 0.3F).setIconCoord(9, 7).setItemName("chickenRaw");
