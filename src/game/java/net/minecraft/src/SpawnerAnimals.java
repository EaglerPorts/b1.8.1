...
public final class SpawnerAnimals {
	...
	protected static final EntitySupplier[] nightSpawnEntities = new EntitySupplier[]{EntitySpider::new, EntityZombie::new, EntitySkeleton::new};
							...
							for(int var24 = 0; var24 < 4; ++var24) {
								...
								if(canCreatureTypeSpawnAtLocation(var36, var0, var20, var21, var22)) {
									...
									if(var0.getClosestPlayer((double)var25, (double)var26, (double)var27, 24.0D) == null) {
										...
										if(var31 >= 576.0F) {
											EntityLiving var38 = (EntityLiving) var13.entityClass.createEntity(var0);
			...
			for(int var8 = 0; var8 < 20 && !var7; ++var8) {
				...
				if(var13 < var11 + 16) {
					...
					if(var13 < 128) {
						...
						EntityLiving var17 = (EntityLiving) var6[var12].createEntity(var0);
				...
				for(int var14 = 0; var14 < var9; ++var14) {
					...
					for(int var16 = 0; !var15 && var16 < 4; ++var16) {
						...
						if(canCreatureTypeSpawnAtLocation(EnumCreatureType.creature, var0, var10, var17, var11)) {
							...
							EntityLiving var21 = (EntityLiving) var8.entityClass.createEntity(var0);
