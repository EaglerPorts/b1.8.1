...
public class GuiSelectWorld extends GuiScreen {
	...
	public void initGui() {
		...
		this.field_35316_k[0] = var1.translateKey("gameMode.survival");
		this.field_35316_k[1] = var1.translateKey("gameMode.creative");
		this.loadSaves();
	...
	static String[] func_35315_i(GuiSelectWorld var0) {
		return var0.field_35316_k;
	}
}
