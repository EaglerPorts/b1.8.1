...
public class StructureStrongholdPieces {
	...
	private static ComponentStronghold func_35851_a(StructureStrongholdPieceWeight var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7) {
